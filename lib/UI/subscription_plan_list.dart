...
class _SubscriptionPlanListState extends State<SubscriptionPlanList> {
  ...
  Future<void> validatePurchase(PurchaseDetails purchaseDetails) async {
    ...
    final param = {
      ...
      'product_id': purchaseDetails.purchaseID ?? '',
    };
  ...
  Future<void> _verifyAndFinishTransaction(
    ...
    final param = {
      ...
      // On both platforms verificationData.serverVerificationData holds
      // the purchase token (Android) or transaction receipt (iOS).
      'token': purchaseDetails.verificationData.serverVerificationData,
    };
