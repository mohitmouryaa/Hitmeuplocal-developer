...
import 'common_promotion_by_id.dart';
...
class _PromotionListScreenState extends State<PromotionListScreen> {
  ...
  void initState() {
    ...
    if(widget.searchType[kSearchType]=="NA"){
      ...
      _radioType = widget.searchType[kSearchType] == "GPS" ? "Location Search" : "Manual Search";
  ...
  _onLayoutDone(_) {
    if (widget.searchType[kSearchType] == "Manual") {
    ...
    if (result[kDataCode] == 200) {
      ...
      if (stateList.isNotEmpty) {
        if(_stateId.isNotEmpty){
          int index = stateList
              .indexWhere((data) => data["id"].toString() == _stateId);
  ...
  Future navigationPromotionPage(id , index) async {
    Navigator.push(
        context,
        PageTransition(
            type: PageTransitionType.rightToLeft, child: CommonPromotionByIdList(id: id.toString(),url: "promotions-list-by-id",distance: _offerList[index].distance == null ? "" : _offerList[index].distance.toString(),))
    );
  }
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                _radioType == "Manual Search"?Column(
                                  children: [
                                    Container(
                                      margin: const EdgeInsets.only(top: 15, bottom: 15),
                                      alignment: Alignment.centerLeft,
                                      ...
                                      child: TextFormField(
                                        ...
                                        onFieldSubmitted: (input) {
                                          if(_stateId.isNotEmpty && _cityController.text.isNotEmpty){
                                            showLoader(context);
                                            updateCategories(type:"city");
                                          }else{
                                            showToast(context, 'Please select state and city both');
                                          }
                                  ...
                                  child: DropdownButtonFormField<dynamic>(
                                    ...
                                    onChanged: (value) {
                                      int index = categoryList.indexWhere(
                                              (data) => data["category_name"] == value);
                                      categoryData=categoryList[index];
                                      _categoryId = categoryList[index]["id"].toString();
                                ...
                                Container(
                                  ...
                                  child: DropdownButtonFormField<dynamic>(
                                    ...
                                    items: subCategoryList
                                        ...
                                        .map((label) => DropdownMenuItem(
                                      child: Text(
                                        label["category_name"]!=null?label["category_name"]:'NA',
                                        style: const TextStyle(
                                            fontWeight: FontWeight.w400),
                                        maxLines: 1,
                                        overflow: TextOverflow.ellipsis,
                                ...
                                Container(
                                  ...
                                  child: Card(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        if(categoryData.isEmpty || subCategoryData.isEmpty) {
                                          if(_stateId.isEmpty || _cityController.text.isEmpty){
                                            showToast(context , 'Please select state and enter city or zip code');
                                          }else{showToast(context , 'Please select category and sub category');}
                                        }else{
                                          if(isValid()){
                                            ...
                                            showToast(context , 'Please enter complete details');
                                          }
                                        }
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      _offerList.isNotEmpty?Expanded(
                          child: Center(
                                      ...
                                      onTap: () {
                                        if(isGuest){
                                          ...
                                          if(trialActive == 1 && trialExpired==0){
                                            ...
                                            navigationPromotionPage(_offerList[index].business_id , index);
  ...
  bool isValid() {
    ...
    if (_radioType == "Location Search" && _categoryId.isNotEmpty) {
      ...
      if (_stateId.isNotEmpty && _cityController.text.isNotEmpty && _categoryId.isNotEmpty) {
        parameterValid = true;
