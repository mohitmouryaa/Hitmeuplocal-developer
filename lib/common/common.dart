...
void onBackPress(BuildContext context, Function drawerCall, Function openViewCall) {
  Navigator.pushNamedAndRemoveUntil(context, '/', (_) => false);
  Navigator.pushReplacement(
    context,
    MaterialPageRoute(
        builder: (BuildContext context) => const AppDrawer(isNotification: false,)),
  );
}
...
Widget roundedButton(String buttonLabel) {
  var loginBtn = Container(
    ...
    child: Text(
      buttonLabel,
      style: const TextStyle(
          color: buttonColor, fontSize: 18.0, fontWeight: FontWeight.normal),
    ),
  );
  return loginBtn;
}
...
void showToast(BuildContext context, String msg) {
 ...
 Widget showCustomToast(BuildContext context, String msg) {
  Widget toast = Container(
    ...
    child: Text(msg,style: TextStyle(fontSize: 16.0 , color: Colors.white),),
  );
  return toast;
}
