...
class _NotificationListScreenState extends State<NotificationListScreen> {
  ...
  void getNotificationListData() async {
    ...
    final String url = '$baseUrl/notifications-list/${userData[kId]}';
  ...
  Future<void> navigationPromotionPage(String id) async {
    final result = await Navigator.push(
      context,
      PageTransition(
        type: PageTransitionType.rightToLeft,
        child: CommonPromotionByIdList(
            id: id, url: 'promotion-list-by-notification', distance: '',),
      ),
    );
    if (!mounted) return;
    if (result == null) {
                          ...
                          itemBuilder: (context, index) {
                            DateTime tempDate =
                                DateFormat('yyyy-MM-dd hh:mm:ss')
                                    .parse(_notificationList[index].createdAt);
                            return InkWell(
                              onTap: () {
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _notificationList[index].read == '1'
